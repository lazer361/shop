...
// 
function PizzaBlockCart({i, imageUrl, title, types, sizes, sum}) {
    ...
    const onDel = () => {
        ...
        copy.splice(i, 1);
        copy.map((item, i) => {
            copyTwo.push([i, item[1], item[2], item[3], item[4], item[5], i]);
        });
        
        setPurchases(copyTwo); 
    }
    return(
    ...
    <div className="cart__item-remove">
        <div onClick={onDel} className="button button--outline button--circle">
