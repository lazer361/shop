...
const Cart = () => {
    ...
    const pizzasCard = purchases.map((obj) => (

        <PizzaBlockCart key={obj[6]} i={obj[6]} imageUrl={obj[3]} title={obj[1]} types={obj[5]} sizes={obj[4]} sum={obj[2]}></PizzaBlockCart>
    ));
    ...
    <div className="container container-cart">
        <div className="cart">
            ...
            {(purchases.length == 0) ? <EmptyCart /> : pizzasCard}
            </div>
            <div className="cart__bottom">
              <div className="cart__bottom-details">
                <span> Всего пицц: <b>{payCount} шт.</b> </span>
                <span> Сумма заказа: <b>{moneyCount} ₽</b> </span>
              </div>
